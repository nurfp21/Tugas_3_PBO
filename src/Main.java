        ...
        switch (pilih){
            case 1:
                ...
                for(int i=0; i<banyak; i++) {
                    ...
                    System.out.println("TOTAL YANG HARUS DIBAYAR : " + (tran.hargaElektronik(monitor, memori, tran.jumlah)-tran.potonganHarga()));
                }
                break;
            case 2 :
                System.out.println("BERAPA BANYAK DATA : ");
                ...
                for(int i=0; i<banyak; i++) {
                    ...
                    System.out.println("TIPE BARANG : " + elek.getTipe_barang());
                    System.out.println("TOTAL YANG HARUS DIBAYAR : " + tran.hargaElektronik(tipe, tran.jumlah));
                }
                break;
            default:
